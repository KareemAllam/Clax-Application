...
import 'package:flutter_complete_guide/Components/CreditCardType.dart';
import 'package:flutter_complete_guide/Provider/Account.dart';
import 'package:flutter_complete_guide/widgets/FormGeneral.dart';
...
class _PaymentAddState extends State<PaymentAdd> {
  ...
  void validatation() async {
    ...
    if (error == true) {
      ...
      bool result =
          await Provider.of<Account>(context, listen: false).addCard(body);
      print(result);
      if (result) {
